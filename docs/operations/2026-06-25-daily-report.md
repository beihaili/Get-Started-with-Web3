...
- Phase 2 now has a learner-facing Wallet Lab course note; CI still needs to run for the latest explainer commit after push.
...
1. Push the Wallet Lab explainer commit and wait for PR #220 CI.
