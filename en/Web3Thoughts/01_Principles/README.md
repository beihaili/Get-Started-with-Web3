...
> **Navigating the Web3 ocean requires a reliable set of principles as your compass. These are the core principles I've distilled from personal experience, and I hope they help you navigate this emerging world safely and successfully.**

![](https://img.shields.io/badge/Author-Beihai-blue)
![](https://img.shields.io/badge/Difficulty-Beginner%20Recommended-yellow)
...
In the Web3 world, following some fundamental principles is crucial. Just as Ray Dalio wrote his *Principles* and CZ wrote his, I'd like to share my guiding principles for the Web3 space.

These principles are not axioms but rather my personal understanding and reflections. There is no absolute right or wrong -- they are simply shared experience. I hope they provide some practical guidance for Web3 newcomers to avoid common pitfalls in this world full of opportunity and risk.
...
- **Don't speculate with perpetual contracts**
...
**Core Principle**: Only invest money that won't affect your quality of life. Ensure you can maintain a normal life even in extreme market conditions.
...
|:-----------:|:--------------------:|:-----:|
| Small amounts | Trusted hot wallets | Don't use suspicious new wallets |
| Medium amounts | Mainstream hardware wallets | Don't store long-term on centralized exchanges |
...
- **Don't trust any Web3 project or individual by default**
- **Don't trust any institution by default, including major exchanges**
- **Don't trust any code audit results by default**
- **Don't trust any "guru" recommendations by default**
...
|:--------------:|:---------------:|:----------------:|
| FOMO (Fear of Missing Out) | Set clear entry criteria | Write down your investment thesis in advance; don't change your standards because prices go up |
...
|:------:|:--------------:|:-----:|
| Sharing Knowledge | Publicly share valuable insights | Don't hoard core information for personal gain |
