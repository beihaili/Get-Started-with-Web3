...
- [x] Add privacy-preserving GA4 custom events for landing CTAs, AI entrypoints, search discovery, lesson completion, support link clicks, and wallet-copy intent.
