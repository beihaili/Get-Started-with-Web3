...
<div align="center">
  <strong>A systematic, open-source Bitcoin and Web3 learning platform</strong><br/>
  <em>6 modules, 37 lessons, AI tutor, badge system — learn at your own pace</em>
</div>

<br/>

<div align="center">
  <a href="https://beihaili.github.io/Get-Started-with-Web3/">Live Demo</a> &nbsp;|&nbsp;
  <a href="./zh/">Chinese Tutorials</a> &nbsp;|&nbsp;
...
| Feature | Description |
|---------|-------------|
| **6 Modules, 37 Lessons** | From Web3 basics to deep Bitcoin cryptography and ecosystem tools |
| **AI Tutor** | Gemini-powered assistant answers questions in context of the current lesson |
| **Badge System** | Earn achievement badges and XP as you complete modules |
...
### Module 1: Web3 Quick Start (6 lessons)
...
### Module 3: Bitcoin Network and Consensus Layer (3 lessons)
...
### Module 5: Web3 Deep Thinking (7 lessons)
...
- **State**: Zustand (four stores, three persisted to localStorage)
...
- **ETH / EVM**: `0x2a1C08d5E8C534D9D8A07b3cFEF56fc1e7b8b3f2`
