  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {earnedBadgeCount === 0 ? (
          <div className="max-w-2xl mx-auto text-center p-12 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 rounded-xl">
            <Award className="w-24 h-24 mx-auto mb-6 text-slate-600" />
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">
              {t('badges.noBadgesTitle')}
            </h2>
            <p className="text-slate-500 dark:text-slate-400 mb-6">{t('badges.noBadgesDesc')}</p>
            <Link
              to={`/${lang}/dashboard`}
          ...
          <>
            ...
            <div className="max-w-4xl mx-auto p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 rounded-xl">
