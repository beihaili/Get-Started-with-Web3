...
**Concrete learner outcome:** A learner or agent can follow a cited path through 61 lessons and retrieve curriculum context through `llms.txt` or the read-only MCP server.
...
| 2026-05-20 | GitHub roadmap issue | https://github.com/beihaili/Get-Started-with-Web3/issues/156#issuecomment-4495517571           | Published | 614 stars at publication | Follow-up linking the Layer 2 / AI-native release from the pinned 1000-star roadmap.                        |
| 2026-05-20 | GitHub roadmap issue | https://github.com/beihaili/Get-Started-with-Web3/issues/156#issuecomment-4495955406           | Published | 614 stars at publication | Public update for privacy-preserving behavior analytics, PR #208, main deploy evidence, and starter issues. |
