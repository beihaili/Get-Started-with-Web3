...
**Concrete learner outcome:** A learner or agent can follow a cited path through 62 lessons and retrieve curriculum context through `llms.txt` or the read-only MCP server.
