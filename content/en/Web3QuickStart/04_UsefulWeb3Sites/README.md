# Useful Web3 Websites for Beginners
...
- [Blockchain Explorers](#i-blockchain-explorers)
- [Cryptocurrency Market Data Websites](#ii-cryptocurrency-market-data-websites)
- [DeFi Tools](#iii-defi-tools)
- [Reputable Exchange Websites](#iv-reputable-exchange-websites)
- [FAQ](#faq)
- [Summary](#summary)
...
When registering for Binance, feel free to use my referral code for a trading fee discount: [Referral Code](https://www.binance.info/activity/referral-entry/CPA?ref=CPA_00EZI5X6IS)
...
When registering for OKX, feel free to use my referral code for a trading fee discount: [Referral Code](https://cnouyi.studio/join/7133496)
