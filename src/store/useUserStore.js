 ...
 * @property {...any} [extra] - Additional metadata fields may be included via spread (...metadata).
 */
...
export const useUserStore = create(
  persist(
    (set, get) => ({
      ...
      // Actions - 学习进度
      /**
       * @description Mark a lesson as completed. Adds 100 XP, updates streak, updates title, and checks for special badges.
