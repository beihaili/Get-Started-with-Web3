...
- [**第 06 讲：Taproot升级详解**](./06_Taproot/README.MD) ✅
  - 数据隐私和脚本优化
...
- [**第 10 讲：P2P网络协议**](./10_P2PProtocol/README.MD) ✅
  - 节点发现和连接管理
  - 数据传播和同步机制
...
- [**第 14 讲：分叉机制与BIP流程**](./14_ForksBIPs/README.MD) ✅
  - 软分叉vs硬分叉
  - 协议升级的社会共识
...
- [**第 16 讲：比特币RPC应用开发**](./16_BitcoinRPC/README.MD) ✅
  - 系统集成和自动化开发

- [**第 17 讲：比特币开发工具**](./17_BitcoinLowFeeBroadcast/README.MD) ✅
  - 实用工具开发和费用优化

- [**第 18 讲：Bitcoin Script脚本系统**](./18_BitcoinScript/README.MD) ✅
  - 基于栈的脚本语言
  - 条件支付和智能合约应用
...
- [**第 20 讲：Ordinals与生态创新**](./20_Ordinals/README.MD) ✅
  - NFT技术和生态拓展

- [**第 21 讲：比特币DeFi与跨链**](./21_DeFiCrossChain/README.MD) ✅
  - 去中心化金融应用
  - 跨链协议和创新
...
| 技术层 | 讲次范围 | 配套工具 | 主要功能 |
|--------|----------|----------|----------|
| **🔐 密码学基础层** | 第01-02讲 | `crypto_examples.py` | 密码学操作演示 |
| **📊 数据层** | 第03-08讲 | `transaction_examples.py` | 交易创建和分析 |
| **📊 数据层** | 第05讲 | `segwit_examples.py` | SegWit技术分析 |
| **🌐 网络层** | 第09-11讲 | `network_examples.py` | 网络和节点管理 |
| **🤝 共识层** | 第12-14讲 | `mining_examples.py` | 挖矿和共识机制 |
| **💼 应用层** | 第15-21讲 | `rpc_examples.py` | RPC应用开发 |
| **💼 应用层** | 第18讲 | `script_examples.py` | Script脚本编程 |
